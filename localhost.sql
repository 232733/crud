...
--
-- Host: localhost
-- Generation Time: May 30, 2018 at 03:02 PM
...
INSERT INTO `info` (`id`, `name`, `gender`) VALUES
(8, 'John', 'Male'),
(19, 'Kaine', 'Unknown');
--
-- Database: `phpmyadmin`
...
INSERT INTO `shoes` (`model_id`, `size`, `color`, `style`) VALUES
(1, '6.5', 'red', 'heel'),
(2, '6.5', 'black', 'heel'),
(3, '6.5', 'purple', 'heel'),
(4, '7.5', 'yellow', 'toe'),
...
INSERT INTO `store` (`store_id`, `storename`, `city`) VALUES
(NULL, 'Shoestore', 'Aflats'),
(NULL, 'Shoestore', 'WellCity'),
(NULL, 'Footstore', 'WellCity'),
(123, 'Shoestore', 'Aflats'),
(124, 'Shoestore', 'Wellcity'),
(125, 'Footstore', 'Wellcity');
